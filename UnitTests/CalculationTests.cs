...
namespace UnitTests
{
    ...
    public class CalculationTests
    {
        ...
        public void BasicXTimesYIsSelfDescribing()
        {
            ...
            Assert.AreEqual("Basic contains a PROD, whos result is found by the multiplication of the given Basic.X (5) and the given Basic.Y (5) yielding a value of 25", description);
        }
